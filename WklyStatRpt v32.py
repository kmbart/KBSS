...
def putPointsOnList(n, catgList) -> list:                         # number of teams, category list (team, value) -> (team, value, points)
...
for ix in range(0, numOfTeams - 1):
    print (pitRankList[ix][0], "{: 4.2f}".format(pitRankList[ix][1][0]),
           hitRankList[ix][0], "{: 4.2f}".format(hitRankList[ix][1][1]),
           totRankList[ix][0], "{: 4.2f}".format(totRankList[ix][1][2]))
