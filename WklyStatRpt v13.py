...
def printPitcherStats(s):
    print (' '
           ...
           ,"{: 5.1f}".format(s[28])                            # innings pitched
           ,"{: 3d}".format(s[29])                              # hits
           ,"{: 3d}".format(s[31])                              # walks
           ,"{: 3d}".format(s[34])                              # earned runs
           ,"{: 3d}".format(s[35])                              # strikeouts
           ,"{: 6.3f}".format(9 * (s[34] / s[28]))              # ERA
           ,"{: 6.3f}".format((s[29] + s[31]) / s[28])          # WHIP
        ,file = statsFile)
...
#                print (); print ('currstats:', currStats); print ()
                ...
                if currStats == None:
                    print ('  <No stats returned>', file = statsFile)
