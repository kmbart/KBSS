...
# open weekly stats file
        statsFilename = 'WT' + str(seasonCCYY) + str(week) + '.txt'
#        print ('sfilename:', statsFilename)
...
#                        print ('hitStats:', currStats)
            ...
            for aLine in tempTList: print(aLine, file=weeklyStatsFile)

            print(makeHeaderPitchers(), file=weeklyStatsFile)
            for aLine in tempPList: print(aLine, file=weeklyStatsFile)
            print(' ', file=weeklyStatsFile)

            print(makeHeaderHitters(), file=weeklyStatsFile)
            for aLine in tempHList: print(aLine, file=weeklyStatsFile)
            print(' ', file=weeklyStatsFile)

            print(team, ' - Reserved and Minor League Players', file=weeklyStatsFile)
            for aLine in tempEList: print(aLine, file=weeklyStatsFile)
            print(' ', file=weeklyStatsFile)
            print(' ', file=weeklyStatsFile)
