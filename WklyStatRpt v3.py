...
# get the results of the SQL call
                stats = getPlayerStats (statWeek, playerID)
#                print ('stats:', stats)
...
#                        printPitcherStats(stats)
                        ...
                        currPos = findPositions(stats)
                        prevStats = getPlayerStats (prevSeasonLastWeek, playerID)
                        
                        if prevStats != None:
                            prevPos = findPositions(prevStats)
                        ...
                        printHitterStats(stats, currPos)
