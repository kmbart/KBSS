...
# print player info
def printTeamHitterTotals(t):
    print (t[0],                                               # team abbr
           leagueStats[t]['AB'],                               # AB
           leagueStats[t]['H_Runs'],                           # runs
           leagueStats[t]['H_Hits'],                           # hits
           leagueStats[t]['H_HR'],                             # HR
           leagueStats[t]['H_RBI'],                            # RBI
           leagueStats[t]['H_SB'],                             # steals
          )
...
#                    print ('type:', playerType)
                    ...
                    if playerType == 'P':
                        sumPitcherStats(teamAbbr, statDiff)
